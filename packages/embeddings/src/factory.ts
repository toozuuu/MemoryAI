import { EmbeddingProvider, LocalEmbeddingProvider, OpenAIEmbeddingProvider } from './provider.js';

export function getEmbeddingProvider(type?: string): EmbeddingProvider {
