...
export function assertUserAccess(user: AuthUser, targetUserId: string): void {
  if (user.role === 'admin') return;
...
export function assertProjectAccess(user: AuthUser, projectId?: string | null): void {
...
export function authorizeMemoryAccess(user: AuthUser, memory: Memory, operation: 'read' | 'write' | 'delete'): void {
